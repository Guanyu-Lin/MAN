...
class SASRecModel(SLI_RECModel):
    ...
    def _build_seq_graph(self):
        ...
        model_outputA = tf.concat([self.target_item_embedding_A, self.cross_item_A, hist_embedding_mean_A, cross_seqA_mean, self.group_A], -1)
        model_output = tf.concat([self.target_item_embedding,  hist_embedding_mean], -1)
        model_outputB = tf.concat([self.target_item_embedding_B, self.cross_item_B, hist_embedding_mean_B, cross_seqB_mean, self.group_B], -1)
